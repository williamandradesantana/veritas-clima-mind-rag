...
def main():
    ...
    if total_vectors == 0:
        ...
        documents = gather_documents("data", subfolder="blog_scientifc_basis_weather_forecast")
    ...
    while True:
        ...
        log_file = "logs/behavior_log_blogs_scientifc_basis_weather_forecast.txt"
